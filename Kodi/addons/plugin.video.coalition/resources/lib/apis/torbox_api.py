...
class TorBoxAPI:
	...
	def user_cloud(self, request_id=None, check_cache=True):
		string = 'coalition_tb_user_cloud_info_%s' % request_id if request_id else 'coalition_tb_user_cloud'
	...
	def user_cloud_usenet(self, request_id=None, check_cache=True):
		string = 'coalition_tb_user_cloud_usenet_info_%s' % request_id if request_id else 'coalition_tb_user_cloud_usenet'
	...
	def user_cloud_webdl(self, request_id=None, check_cache=True):
		string = 'coalition_tb_user_cloud_webdl_info_%s' % request_id if request_id else 'coalition_tb_user_cloud_webdl'
	...
	def clear_cache(self):
		try:
			...
			# USER CLOUD
			try:
				dbcur.execute("""SELECT id FROM maincache WHERE id LIKE ?""", ('coalition_tb_user_cloud%',))
				try:
