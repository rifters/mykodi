...
default_icon = kodi_utils.translate_path('special://home/addons/plugin.video.coalition/resources/media/mdblist.png')
fanart = kodi_utils.translate_path('special://home/addons/plugin.video.coalition/fanart.png')
item_jump = kodi_utils.translate_path('special://home/addons/plugin.video.coalition/resources/media/item_jump.png')
...
def build_mdb_list(params):
	...
	maxsize = min(_queue.qsize(), int(kodi_utils.get_setting('coalition.max_threads', '100')))
