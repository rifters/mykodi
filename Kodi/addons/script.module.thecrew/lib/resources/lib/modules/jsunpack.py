...
def unpack(source):
    ...
    try:
        ...
        raise UnpackingError('Unknown p.a.c.k.e.r. encoding.') from exc
...
def _filterargs(source):
    ...
    try:
        ...
        raise UnpackingError('Corrupted p.a.c.k.e.r. data.') from exc
    ...
    def __init__(self, base):
        ...
        if 2 <= base <= 36:
            ...
            try:
                ...
                raise TypeError('Unsupported base encoding.') from exc
