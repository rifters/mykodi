...
#REVOKE ALL SERVICES                
        ...
        for chk, settings_db, addon_id, addon_name, trakt_revoke in addons:
                if exists(chk):
                        ...
                        xbmc.sleep(200)
                        control.restore_fenlt_tkclient() # Restore Fen Light default Trakt Client Key
                        xbmc.sleep(200)
                        control.restore_fenlt_tksecret() # Restore Fen Light default Trakt Secret Key
                        xbmc.sleep(200)
                        control.remake_fenlt_settings()  # Remake Fen Light settings
                        xbmc.sleep(500)
                        control.remake_gears_settings()  # Remake The Gears settings
